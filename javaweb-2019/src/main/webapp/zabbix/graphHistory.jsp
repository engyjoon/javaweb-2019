...
<body id="page-top">
          	...
          	<div class="card shadow w-100 mb-4">
          		<div class="card-header py-3">
          			<h6 class="m-0 font-weight-bold text-primary">
          				Host(${host.hostid}) > Item(${item.itemid}) > Graph
          			</h6>
          		</div>
          		<div class="card-body">
  ...
  <!-- Page level plugins -->
  <script src="${contextPath}/vendor/chart.js/Chart.bundle.min.js"></script>
  ...
  <script>
  	...
  	var loadCharts = function() {
		$.ajax({
			type: 'get',
			url: '${contextPath}/zabbix/history/json/list.do?itemid=${item.itemid}&valuetype=${item.valueType}',
			dataType: 'json'
		}).done(function(data, status) {
			cfgHistory.data.datasets[0].data = data;
			console.log(cfgHistory.data.datasets[0].data);
			var chartHistory = new Chart(ctxHistory, cfgHistory);
		});
  	}
