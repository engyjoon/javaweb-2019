      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="${contextPath}/zabbix/host/list.do" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-icon-split">
            	<span class="icon text-white-50">
            		<i class="fas fa-arrow-right"></i>
            	</span>
            	<span class="text">Go Host List</span>
            </a>
          </div>
          	...
          	<div class="card shadow w-100 mb-4">
          		...
          		<div class="card-body">
					<table class="table table-bordered">
					    ...
					    <tr>
					      <td><a href="${contextPath}/zabbix/history/list.do?itemid=${item.itemid}&valuetype=${item.valueType}&hostid=${host.hostid}">${item.itemid}</a></td>
					      <td>${item.type}</td>
					      <td>${item.hostid}</td>
					      <td>${item.name}</td>
					      <td>${item.key}</td>
